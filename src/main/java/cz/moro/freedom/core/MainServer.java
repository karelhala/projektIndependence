...
public class MainServer {
	...
	public void onMessage(String message, Session session) throws Exception {
		...
		if (player == null) {
			throw new Exception("Player with ID " + session.getId()
					+ " not found");
		}
	...
	private void turn(TurnMsg msg) {
		...
		if (gameHandler.getGame().equals(playerInTurn.getGame())
				&& gameHandler.isThisTeamInRound(playerInTurn.getTeam())
				&& (!gameHandler.isWorldsCellOccupied(msg.getX(), msg.getY()) || gameHandler.isShamanMove(playerInTurn, msg.getX(), msg.getY()))
			...
			gameHandler.setPlayersTurnToWorld(msg.getX(), msg.getY(),
					playerInTurn);
